...
import Colecciones.ListaCategoria;
import Colecciones.ListaProductos;
import DAO.ActualizarListas;
...
public class RegistroProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ListaCategoria.limpiarCategoria();
            ActualizarListas al=new ActualizarListas();
            al.actualizarCategoria();
            idcat=ListaCategoria.obtenerIdCategoria(categoria);
            ...
            if (crud.registrarProducto(prod)) {
