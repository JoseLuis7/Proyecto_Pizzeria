 ...
 * @author jorge
 */
@WebServlet(name = "AccionUser", urlPatterns = {"/AccionUser"})
public class AccionUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AccionUser.class.getName()).log(Level.SEVERE, null, ex);
